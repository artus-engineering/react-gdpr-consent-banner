...
import { Settings2, Palette, CheckCircle2, Shield, Globe, Zap } from "lucide-react";
...
export default function HomePage() {
  const [customTheme, setCustomTheme] = useState<CookieConsentStyle>(
    presetThemes.light
  );
  ...
  const handlePresetChange = (presetName: string) => {
    ...
    theme: customTheme,
        ...
        description: {
          deDE:
            "Wir verwenden Session-Cookies, um Ihre Sitzung auf unserer Website zu speichern. Dieses Cookie ist notwendig, um die Website zu nutzen.",
          enUS:
      ...
      },
      {
        ...
        description: {
          deDE:
            "Wir verwenden Stripe, um Zahlungen auf unserer Website abzuwickeln. Wenn Sie die App nutzen möchten, müssen Sie diesem Cookie zustimmen.",
          enUS:
            "We use Stripe to process payments on our website. If you want to use the app, you must consent to this cookie.",
        },
      ...
      },
      {
        ...
        description: {
          deDE:
            "Wir verwenden Google Ads, um Ihnen relevante Werbung zu zeigen.",
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                A beautifully designed, GDPR-compliant cookie consent system with
                full customization and audit trail capabilities.
              </p>
            </div>
            ...
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription>
                  Customize the appearance of your cookie consent banner with
                  live preview
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <label className="text-sm font-medium mb-4 block text-slate-700">
                        Preset Themes
                      </label>
                          ...
                          >
                            <div className="flex items-center gap-3 mb-3">
                              <div
                                ...
                                style={{ backgroundColor: theme.bgPrimary, border: theme.bgPrimary === "#ffffff" || theme.bgPrimary === "#fffbeb" || theme.bgPrimary === "#fafafa" ? "1px solid #e2e8f0" : "none" }}
                              />
                              <div
                                className="w-8 h-8 rounded-lg shadow-sm"
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {(
                          Object.keys(customTheme) as (keyof CookieConsentStyle)[]
                        ).map((colorKey) => (
                        ...
                        <div className="p-4">
                          <div className="mb-3">
                            ...
                            >
                              ...
                              <span style={{ color: customTheme.primaryColor, textDecoration: "underline" }}>
                                Mehr erfahren
                              </span>
                            </p>
                          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Fully compliant with GDPR, CCPA, and other privacy
                    regulations. Complete audit trail for all consent changes.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Simple configuration with pre-built hooks for Google
                    Analytics, PostHog, Matomo, and more. Just add your IDs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Built-in German and English translations. Easily extensible
                    for any language with i18n support.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Complete control over colors, typography, and layout. Match
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Block content until consent is given. Perfect for embedded
                    videos, maps, and third-party widgets.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Support for granular consent levels. Essential, Functional,
                    Analytics, and Marketing categories.
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground ml-8">
                    Use the color pickers above to customize the banner
                    appearance. Changes update in real-time.
                  </p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-semibold flex items-center gap-2">
                  ...
                  <p className="text-sm text-muted-foreground ml-8">
                    Add your cookie providers with descriptions, privacy links,
                    and cookie details.
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground ml-8">
                    Click &quot;Cookie-Einstellungen öffnen&quot; to see the full banner
